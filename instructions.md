...
3. Search  from windows-style = `file://localhost/M:/music/(.*)`
   Replace with linux-style and deleting = `if [ -f "/run/user/1000/gvfs/mtp:host=%5Busb%3A002%2C004%5D/SD card/music/1-Star..m3u" ]; then rm -f "/run/user/1000/gvfs/mtp:host=%5Busb%3A002%2C004%5D/SD card/music/$1"; fi`
